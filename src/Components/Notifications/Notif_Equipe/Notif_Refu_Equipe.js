...
/**
 * Notifiction affichée si un des joueurs d'une équipe que l'utilisateur à crée refuse d'intégrer
 * l'équipe.
 */
class Notif_Refu_Equipe extends React.Component {
...
export default withNavigation(Notif_Refu_Equipe)