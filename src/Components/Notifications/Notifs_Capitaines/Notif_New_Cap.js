...
class Notif_New_Cap extends React.Component {
        ...
        if(this.state.isLoading) {
           ...
           return(
                <View style = {{flexDirection : 'row', marginTop : hp('2%')}}>
                    ...
                    <View>
                        <Text style = {{marginTop : hp('1%')}}>{this.nomEmetteur() + " est maintenant capitaine de \n l'équipe " + this.nomEquipe()} </Text>
                        <TouchableOpacity 
...
export default withNavigation(Notif_New_Cap)