 ...
 */
export default class Calendrier_Terrain extends React.Component {

    constructor(props) {
        super(props)
        this.terrainId = this.props.navigation.getParam("id", "erreur")
    ...
    getAllDefisAndPartie() {
        ...
        var query =ref.where("terrain", "==", this.terrainId).orderBy("dateParse")
